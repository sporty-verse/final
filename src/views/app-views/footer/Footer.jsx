  ...
  const gridIcons = [
    {
      ...
      Link: "https://www.twitter.com/sporty.verse",
    },
    {
      Id: 2,
      ...
      Link: "https://www.facebook.com/sporty.verse",
    },
    {
      Id: 3,
    ...
    },
    {
      ...
      Link: "https://www.instagram.com/sporty.verse",
    },
  ];
  return (
    <div className="bg-black mt-16 h-full justify-center flex responive">
      <div className="container ">
        <div className="flex justify-between foot-nav">
          <FooterNav
            gridTitle={gridTitle}
            gridAbout={gridAbout}
            gridHelp={gridHelp}
          ...
          <div className="col-span">
            ...
            <span className="flex gap-2 items-center text-white mt-4 mb-4 text-sm">
              <FaLocationDot className="text-xs" /> <span>India</span>
            </span>
          </div>
        </div>
        <Privacy />
